...
public class CannonView extends SurfaceView
    ...
    public CannonView(Context context, AttributeSet attrs) {
        ...
        Log.i(DEBUG_TAG, "in CannonView() constructor");
    ...
    {
        Log.i(DEBUG_TAG, "in onSizeChanged()");
    ...
    {
        Log.i(DEBUG_TAG, "in updatePositions()");
    ...
    {
        Log.i(DEBUG_TAG, "in alignCannon()");
    ...
    {
        Log.i(DEBUG_TAG, "in drawGameElements()");
    ...
    {
        Log.i(DEBUG_TAG, "in showGameOverDialog()");
    ...
    {
        Log.i(DEBUG_TAG, "in releaseResources()");
    ...
    {
        Log.i(DEBUG_TAG, "in surfaceChanged()");
    }
    ...
    {
        Log.i(DEBUG_TAG, "in surfaceCreated()");
    ...
    {
        Log.i(DEBUG_TAG, "in surfaceDestroyed()");
        ...
        while (retry)
        {
            ...
            {
                Log.e(DEBUG_TAG, "Thread interrupted", e);
            }
        }
    ...
    {
        Log.i(DEBUG_TAG, "in onTouchEvent()");
    ...
    private class CannonThread extends Thread
    {
        ...
        {
            Log.i(DEBUG_TAG, "in CannonThread() constructor");
