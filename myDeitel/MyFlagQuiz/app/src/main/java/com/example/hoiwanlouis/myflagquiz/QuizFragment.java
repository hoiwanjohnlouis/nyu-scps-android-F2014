...
public class QuizFragment extends Fragment {
    ...
    {
        Log.v(DEBUG_TAG, "in updateGuessRows()");
    ...
    {
        Log.v(DEBUG_TAG, "in updateRegions()");
    ...
    {
        Log.v(DEBUG_TAG, "in loadNextFlag()");
    ...
    {
        Log.v(DEBUG_TAG, "in getCountryName()");
    ...
    {
        Log.v(DEBUG_TAG, "in disableButtons()");
        for (int row = 0; row < guessRows; row++) {
