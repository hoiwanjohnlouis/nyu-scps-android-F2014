...
public class MyLinearActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.my_linear, menu);
    ...
    public void addListenerOnPrevButton() {
        ...
        prevButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gridIntent;
                gridIntent = new Intent(MyLinearActivity.this, MyGridActivity.class);
    ...
    public void addListenerOnNextButton() {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gridIntent;
                gridIntent = new Intent(MyLinearActivity.this, MyTableActivity.class);
                startActivity(gridIntent);
            }
        });
