 ...
 * {@link HeadingFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HeadingFragment#newInstance} factory method to
...
public class HeadingFragment extends Fragment {
    ...
    public static HeadingFragment newInstance() {
        Log.i("HeadingFragment", "in newInstance()");
    ...
    public void onButtonPressed(Bundle headingFragmentInterfaceBundle) {
        Log.i(DEBUG_TAG, "in onButtonPressed()");
        if (mListener != null) {
            mListener.onHeadingFragmentSymbolCompleted(headingFragmentInterfaceBundle);
        }
    }
