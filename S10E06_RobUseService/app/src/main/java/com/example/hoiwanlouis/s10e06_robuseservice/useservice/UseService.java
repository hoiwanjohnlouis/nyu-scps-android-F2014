package com.example.hoiwanlouis.s10e06_robuseservice.useservice;
...
import com.example.hoiwanlouis.s10e06_robuseservice.simpleservice.IRemoteInterface;
//import com.example.hoiwanlouis.s10e06_robuseservice.useservice.R;
...
public class UseService extends Activity implements ServiceConnection {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		go.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent service = new Intent(
						"com.example.hoiwanlouis.s10e06_robuseservice.simpleservice.GPXService.SERVICE");
		...
		stop.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				releaseBind();
				stopService(new Intent("com.example.hoiwanlouis.s10e06_robuseservice.GPXService.SERVICE"));
			}
		});
